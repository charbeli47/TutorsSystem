...
class Student extends MY_Controller 
{
	...
	function join_link( $primary_key , $row ) {
		...
		$query = 'SELECT b.*, course.name course_name FROM ' . TBL_BOOKINGS . ' b 
			...
			'WHERE (b.status = "session_initiated" OR b.status="running") AND "'.$now.'" BETWEEN start_date AND end_date AND b.student_id = ' . $user_id .' AND booking_id = ' . $primary_key;
