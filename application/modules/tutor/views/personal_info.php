...
<div class="dashboard-panel">
	...
	<div class="row">
		...
		echo form_open_multipart('tutor/personal_info',$attributes);?>
			<div class="col-sm-6 ">
			...
			<div class="col-sm-6 ">
				<div class="input-group ">
					<label>IBAN <?php echo required_symbol();?>:</label>
					<?php
					$val = '';
					if( isset($_POST['submitbutt']) )
					{
					...
					?>
					<?php echo form_error('bank_ac_details');?>
				</div>
			</div>
			<div class="col-sm-6 ">
				<div class="input-group ">
					<label>SWIFT <?php echo required_symbol();?>:</label>
					<?php
					$val = '';
					if( isset($_POST['submitbutt']) )
					{
						$val = $this->input->post( 'Swift' );
					}
					elseif( isset($profile->bank_ac_details) && !isset($_POST['submitbutt']))
					{
						$val = $profile->bank_ac_details;
