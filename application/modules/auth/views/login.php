			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				...
				<div class="sign-block">
					...
					<?php echo form_open(current_uri().(isset($_GET["red"])?$_GET["red"]:""), array('class' => 'form-signup comment-form', 'name' => 'token_form', 'id' => 'token_form'));?>
						...
						<div class="input-group " id="div_gender">
							<label><?php echo get_languageword('gender');?><?php echo required_symbol();?></label>
								<div class="row">
	    						<div class="col-sm-12">
	    							<div class="dark-picker dark-picker-bright">
									<?php 
										$val = set_value('gender');
										echo form_dropdown('gender', $gender_opts, $val, 'id="gender" name="gender" class="select-picker"');?>
									</div>
								</div>
							</div>
						</div>
