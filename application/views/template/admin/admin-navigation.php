<ul class="sidebar-menu">
	...
	<!--SEO Settings Start-->
	<li <?php if(isset($activemenu) && $activemenu == 'seosettings') echo ' class="active"';?>>
		<a href="<?php echo base_url();?>admin/seosettings">
			<i class="fa fa-envelope"></i><?php echo get_languageword('SEO') . ' ' . get_languageword('settings');?></a>
	</li>
	<!--SEO Settings End-->
